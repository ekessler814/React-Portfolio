...
import styles from './connectFourCSS'
import { evalWinner, findLowestRow, genGrid, turnText } from './connectFourLogic'
...
const RenderSquare = ({ info }) => {
  ...
  return (
    <div style={{ backgroundColor: "#6363db", ...styles.padInner }}>
      <div
        onClick={clickCirc}
        style={{
